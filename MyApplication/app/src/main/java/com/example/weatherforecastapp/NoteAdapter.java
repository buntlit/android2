...
import com.example.weatherforecastapp.db.DataReader;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Note note) {
            this.note = note;
            titleNote.setText(note.getCity() + ", Temperature: " + note.getTemperature() + ", Humidity: " + note.getHumidity() + ", Wind speed: " + note.getWind() + ", Weather: " + note.getWeather());
        }
